...
- **M3.7 — Explicit final-submit gate:** deterministic readiness checks, short-lived one-shot human authorization, state/session/document/control fingerprint binding, transactional replay protection, a narrowly scoped Playwright final-submit executor, success-probe confirmation, safe receipts, and indeterminate timeout handling.
